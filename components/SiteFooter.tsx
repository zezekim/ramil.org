export default function SiteFooter() {
  return <footer id="contact" className="footer"><div className="shell footer-inner">
    ...
    <div className="footer-action"><a className="button button-primary" href="mailto:hello@ramil.org">Email Ramil <span aria-hidden="true">↗</span></a><p>Manila · Remote · Available for select architecture and engineering work</p></div>
